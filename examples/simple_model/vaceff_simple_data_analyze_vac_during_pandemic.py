...
def calc_vaceff_incidence_per_person_day(vac1_shift_days=0, vac2_shift_days=7):
    # set diagram
...
def calc_vaceff_average_daily_incidence_per_person_day(
    ...
    # drop_index = df.loc[df[vac2_day_shift] <= vac2_min_limit].index
    drop_index = df.loc[df["vac2_pos"] <= vac2_min_limit].index
    ...
    if outcsv:
        df.to_csv(
            "{}_vac0shift_{}_vac1shift_{}_pos_shift_days_{}_vac2_min_limit_{}.csv".format(
                log_filename,
                vac1_shift_days,
                vac2_shift_days,
                pos_shift_days,
...
vaceff_incidence_per_person_day = calc_vaceff_incidence_per_person_day(
    vac1_shift_days=0, vac2_shift_days=7
)
vaceff_average_daily_incidence_per_person_day = (
    calc_vaceff_average_daily_incidence_per_person_day(
        vac1_shift_days=0, vac2_shift_days=7, pos_shift_days=4, vac2_min_limit=0
    )
)
